...
| หัวข้อ | คำตอบแบบสั้น เข้าใจง่าย |
|---------|----------------------------|
| **Memory Types** | 🔹 **SRAM** เก็บข้อมูลที่เปลี่ยนแปลงได้ เช่น ตัวแปรใน **stack**, **global**, **heap**<br>🔹 **Flash Memory** เก็บข้อมูลถาวร เช่น โค้ดโปรแกรม และข้อความคงที่ (`const`, string) |
| **Address Ranges** | 🔹 **SRAM:** `0x3FFB0000 – 0x3FFDFFFF`<br>🔹 **Flash:** `0x400D0000 – 0x40400000` |
| **Memory Usage** | 🔹 **SRAM รวม:** ~520 KB (ใช้งานได้จริง ~320 KB)<br>🔹 **Flash รวม:** ~4 MB (เก็บโค้ดและข้อมูลถาวร)<br>🔹 **SPI RAM:** ไม่มีใน QEMU (0 bytes) |
